...
#ifndef _STAGE1_CORE128_H_
#define _STAGE1_CORE128_H_
...
#define Q_SOA_BATCH_SIZE (5*30*192)

typedef struct {
	uint64 p[Q_SOA_BATCH_SIZE];
	uint64 lattice_size[Q_SOA_BATCH_SIZE];
	uint32 roots[4 * POLY_BATCH_SIZE][Q_SOA_BATCH_SIZE];
} q_soa_t;
